...
// Class ที่สร้างตามที่คุณได้ให้ไว้
class Searchbank extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> banks = const [
    ...
    {'name': 'ธนาคารกรุงไทย(Krungthai)', 'logo': Icons.account_balance_outlined},
    ...
    {'name': 'ธนาคารกรุงศรีอยุธยา(Krungsri)', 'logo': Icons.account_balance_outlined},
              ...
              itemBuilder: (context, index) {
                return ListTile(
                  leading: const CircleAvatar(
                    ...
                    child: Icon(Icons.account_balance_outlined, color: Colors.black54),
                  ),
